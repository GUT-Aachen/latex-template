...
\documentclass[	paper=a4,  % paper size set to DIN A4
								...
								listof = entryprefix,  % add entry prefix to list of figures and tables
...
% ########################
	...
	\ihead*[\sffamily\leftmark]{\sffamily\headmark}  % Inside show caption of chapter (left) / section (right); on plain pages allways chapter (leftmark)
	\ohead*{\sffamily\pagemark}  % Outside show page number
	
	% Define footer	
	\ifoot*{\sffamily\myFootText}  % Show authors name
...
% ################################################
	...
	\InputIfFileExists{additionals/user_config.tex}{}{
		...
		\def\myAuthor{Your Name, if necessary Birth Name}
		\def\myAuthorSex{}  % male/female
